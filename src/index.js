...
function defaultPage(enter) {
    let default = `https://api.openweathermap.org/data/2.5/weather?q=London&units=metric&appid=53aff9595b18349d32179fdacc6d01bf`;
    axios.get(`${default} `).then(showWeather);
}
